...
import { Expense, ExpenseProps, UseExpenseState } from "../../types/expenses/expenses";
...
interface Props {
  ...
  onCancel: () => void;
  onSubmit: (expenseData: ExpenseProps) => void;
}
...
const ExpenseForm = ({
  ...
  const [inputs, setInputs] = useState<UseExpenseState>({
    amount: {
      value: defaultValue ? defaultValue.amount.toString() : "",
      isValid: true,
    },
    date: {
      value: defaultValue ? defaultValue.date.slice(0,10) : "",
      isValid: true,
    },
    description: {
  ...
  const inputChangeHandler = (
    ...
    setInputs((prev) => ({
      ...prev,
      [identifier]: { value: text, isValid: true },
    }));
  };
